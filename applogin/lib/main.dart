...
//////////////////////////////////////////////////////
// 4. Lobby Page (Enhanced with Leaderboard)
//////////////////////////////////////////////////////
class LobbyPage extends StatelessWidget {
  final String fullName;
  LobbyPage({required this.fullName});

  // Example leaderboard data (dummy for now)
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              // 🔹 Farming Details Navigation
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => FarmingDetailsPage(),
                    ),
                  );
                },
                style: ElevatedButton.styleFrom(
...
// Farming Details Page with AgriPlay Theme
          ...
          child: Column(
            children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items:
                      farmSizes
                          ...
                          .toList(),
                  onChanged: (val) => setState(() => selectedFarmSize = val),
                ),
              ),
              _buildBoxField(
                DropdownButtonFormField<String>(
                  ...
                  items:
                      irrigationMethods
                          ...
                          .toList(),
                  onChanged: (val) => setState(() => selectedIrrigation = val),
                ),
              ),
              _buildBoxField(
                TextField(
                  ...
                  keyboardType: TextInputType.number,
                  decoration: InputDecoration(
                    labelText: "Average Water Used (liters/season)",
                    border: InputBorder.none,
                  ),
                ),
              ),
              ...
              _buildBoxField(
                DropdownButtonFormField<String>(
                  decoration: InputDecoration(
                    labelText: "Frequency of Irrigation",
                    border: InputBorder.none,
                  ),
...
class NextPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        // Removed the text here as requested
        child: Container(),
      ),
    );
  }
...
class GameLevelsPage extends StatelessWidget {
  final List<Map<String, String>> levels = [
    {"title": "Level 1: Awareness", "desc": "Quiz on water scarcity in Kerala"},
    {
    ...
    {"title": "Level 5: Community Farming", "desc": "Teamwork-based challenge"},
    {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text("${level["title"]} Coming Soon!"),
                        ),
                      );
                    },
                  ),
